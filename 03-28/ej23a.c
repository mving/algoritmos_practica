...
bool es_bisiesto(int agno) {
	...
	return agno % 100 != 0; // Notar un detalle: No puede hacerse "return agno % 100;" porque si bien cualquier entero tiene un valor de verdad, sólo 1 es la etiqueta true del tipo bool.
	/*if(agno % 100 != 0)
		return true;
	return false;*/
}
